...
public enum EnumCircumstanceCards implements EnumCardImpl {
	...
	HOME_BATTERY_SYSTEMS("Defeat one opponent to win free home battery systems.", "Pick an opponent for rock, paper, scissors. Winner moves forward one, loser moves backwards one."),
	...
	SCARCE_RESOURCES("War Over Scarce Resources", "Choose an opponent and play one round of rock, paper, scissors. Winner moves ahead one space, loser back one space"),
	SAILBOAT_FORCE("Convert your Navy to an all sailboat force!", "Move ahead one space."),
	VOLCANO_ERUPTS("Huge volcano erupts!", "Particles in the air reflect sunlight and cool the Earth temporarily. Move ahead two spaces"),
